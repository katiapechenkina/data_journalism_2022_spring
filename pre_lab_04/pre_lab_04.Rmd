...
Description: it creates a new joined dataframe
```{r}
...
i `x$zip` is of type <character>>.
i `y$zip` is of type <double>>.

Meaning: Dataframes have different column data types for zip code.   
```{r}
...
Description: Dataframe issue has been fixed. ZCTA5N is column for zip codes. 
```{r}
...
**Answer**41968 loans. Average is 55546.84, median is 19949
...
**Answer**112056	loans. Average amount is 89194.67, median is 20833
...
**Answer** Rural loan count: 145, average amount is 44815.22	, median is 19064.57
Urban loan count: 41823, average amount is 55584.05, median is 19950
...
**Answer**
Rural loan count: 18083, average amount is 74463.32		, median is 20833
Urban loan count: 93973, average amount is 92029.39, median is 20833
```{r}
