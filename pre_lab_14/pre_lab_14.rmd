...
**Answer** We see a dataframe with over 152K tweets, 12 columns. 
...
**Answer**The function will give us only one example of each word. Makes words easier to analyse. 
...
**Answer**New data frame with over 5 million unique words is created. 
```{r}
...
**Answer**Counting unique words, sorting the in the order of what words appear most frequently. Making a graph. 
...
**Answer**Removing words by using antijoin and the data for "stop words" that we loaded. Now we get a list of other words that appear on twitter. 
...
**Answer**Getting rid of the stop words. COunting the percentage of time that the words appear. 
...
**Task** Run the following code and describe the results.
**Answer** We see most common non generic words used. 
...
**Task** Run the following code and describe the results.
**Answer**Getting the most used 2021 words phrases. 
...
**Task** Run the following code and describe the results.
**Answer** Comparing Democratic and Republican tweets and the most used words in them . More tweets about health and heath care coming from Democrats. Frequent use of "American people" by republicans. 
...
**Task** Run the following code and describe the results.
**Answer**2020 - lots of covid and Trump mentions. 2021 - lots of covid and vaccine, but also Joe Biden and illegal immigrants. Also, not Trump mentions in 2021 (in the top ten)and lots of covid positive. 
...
**Answer**
Trump could be a negative word for millions of people. Mostly everything looks predictable and makes sense. 
```{r}
