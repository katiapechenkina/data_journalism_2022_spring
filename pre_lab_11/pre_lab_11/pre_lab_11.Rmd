...
**Answer** A screen shot of hospital related documents of different formats 
...
**Answer** A data frame with colums such as ID, NAME, ADDRESS, TELEPHONE, POPULATION, NAICS_CODE, BEDS, TRUAMA, geometry, etc 
...
**Answer**
We get the data frame that has information about Maryland hospitals. 
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** We see a standard R data frame with information on different type of MD hospitals, how many there are and a geometry column.
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
We filtered our MD general acute care hospitals 
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
We see a scatter plot with hospital location based on their longitude-latitude. 
```{r}
md_hospitals %>%
  ggplot() + 
  geom_sf() + 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Installing a new package called tigris
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A dataframe (kind of messy)with 18 columns that have some unfamiliar names. 
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
For some reason nothing happens for me here. 
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
We get a map of Maryland with outlined counties. Looks very neat. 
```{r}
md_counties %>%
  ggplot() + 
  geom_sf() + 
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Same map but now with the hospitals locations shown as dots. 
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Added beds data to the map. Added color for better understanding. 
```{r}
...
**Answer** Installed libraries and my census api key. 
...
**Task** Run the following code. Describe the output in the space below.
**Answer** 
We get a similar data frame to what we had earlier but this one is messier. 
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
A near 2 column data frame of MD counties and number of hospitl beds. 
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
A data frame with 5 columns that provide info on each of MD's counties population numbers. 
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** New column "geometry" is added 
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Displaying county and beds data frame. 
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Cleaning up the data frame. Now the dataframe looks messy again and I'm starting to think it's my R's issue, not the code's. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The code converted values to 0. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**Counted the number of bed per 100k population. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A color coded map displaying where most and least hospital beds are located in MD. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Easier to see colors are added to the map. 
...
**Answer** More color has been added to see the differences in detail. Baltimore has the most hospital beds, and so does one county in Western Maryland. Eastern Shore is doing better than Southern MD, including PG COunty. 
