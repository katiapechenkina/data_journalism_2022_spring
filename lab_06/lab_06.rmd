...
**A6** 18 regions had net positive migration. 

```{r}
# Write the code to produce your answer here
domestic_migration %>% mutate(net_positive=(`2016-2017`+`2017-2018`+`2018-2019`)) %>%
filter (net_positive > 0)

domestic_migration %>% filter(`2016-2017` > 0)
