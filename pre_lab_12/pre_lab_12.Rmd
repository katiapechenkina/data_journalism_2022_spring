...
**Answer**
Reading in the files into a dataframe, cleaning names and displaying by vaccinations by county and by dates
```{r}
...
**Answer**
26 rows, we have an N/A row and an Unknown row
...
**Answer** Total vaccination doses available and administered. 
...
**Answer**
The top days had the most number of vaccines administered. 
```{r}
...
**Answer** A lot of vaccines were available at some point, then the trend goes down.
...
**Task** Run the following code and put the value of `sub` in the answer.
**Answer**The number of people in Prince George's County who got fully vaccinated on March 06 decreased by -73.77 percent compared to the week b
...
**Answer**The chart shows the number of reported cases in different counties on different months. 
...
**Task** Run the following code and describe what the resulting chart shows
**Answer**The chart shows continuous cases increase. 
...
**Answer**
Number of cases by county in Maryland
```{r}
ggplot() +
