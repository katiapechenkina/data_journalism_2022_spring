...
**Answer**
Cities start with either an uppercase A or lowercase a
```{r}
...
**Answer** Capslock ABERDEEN to Aberdeen, annapolis to Annapolis,ABINGDON to Abingdon 
...
Note:
I cleaned up everything that I was sure of, but what's left are things like "MD" or names of Naval Bases (not cities), also a couple of neighborhoods(also not cities)
