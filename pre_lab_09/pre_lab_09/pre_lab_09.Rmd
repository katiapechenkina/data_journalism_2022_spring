...
**Answer**55 columns, 195,869 rows
...
**Answer** The code asks to display top 10 MD counties that have the most loans. 
...
**Answer** The code for ggplot is introduced but nothing but a gray square comes up yet. 
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer** The code created a data chart. It contains the same information on Maryland counties but is now instead in a form of a chart. 
...
**Answer** The code gave the chart the command to use the descending order. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The names of counties now appear on the lest side and they are not messed up at the bottom anymore. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The code made the chart a little more cleaned up and visually more appealing. The gray background color is removed. 
...
**Answer** The background color is now blueish. 
```{r}
maryland_ppp_top_counties %>%
  ggplot() +
  geom_bar(aes(x=reorder(project_county_name,total_loans), weight=total_loans)) +
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer**
A title,source, and "total loans" have been added
```{r}
maryland_ppp_top_counties %>%
  ggplot() +
  geom_bar(aes(x=reorder(project_county_name,total_loans), weight=total_loans)) +
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** A dataframe for total loans number and the date they were approved.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer**
A line chart for the previous data appears. 
```{r}
ppp_maryland_loans_by_date %>%
  ggplot() + 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer**
The line chart now shows more specific data by month but it's still messy at the bottom. 
```{r}
ppp_maryland_loans_by_date %>%
  ggplot() + 
  geom_line(aes(x=date_approved, y=total_loans)) + 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer**The line chart is cleaner and more readable. The months are clearly visible. The text elements have been turned 45 degrees to avoid the overlap. 
```{r}
ppp_maryland_loans_by_date %>%
  ggplot() + 
  geom_line(aes(x=date_approved, y=total_loans)) + 
