...
A3:
Business names are  "DM MOTOR INC","DUTCH MILLER OF CHARLESTON INC","DUTCH MILLER OF CHARLOTTE INC","DUTCH MILLER SUBARU INC","DUTCH MILLER CHEVROLET INC". Those are all auto dealerships. 
```{r}
...
filter(name == "DM MOTOR INC","DUTCH MILLER OF CHARLESTON INC","DUTCH MILLER OF CHARLOTTE INC","DUTCH MILLER SUBARU INC","DUTCH MILLER CHEVROLET INC")
