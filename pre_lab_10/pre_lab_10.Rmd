...
**Answer** Copy the url of the graphic you published here. https://datawrapper.dwcdn.net/HEZSv/1/
...
**Answer** Describe what the code below is doing and the output.The code creates a new data frame, grouping by MD counties, and summarizing number of loans in each one. 
...
**Answer** Describe what the code below is doing and the output. The code is grouping by MD counties, and filtering out the 6 ones with the highest ppp loan amounts. 
...
**Answer** Describe the contents of the new `fips_code` column. The content is zip codes displayed in a traditional 5-digit manner just like the Datawrapper needs
...
Data frame with 8 columns that have been cleaned up and displaying the joined data. 
```{r}
...
**Answer** Describe the changes from the previous map. The map "zooms in" to just show Maryland. 
...
**Answer** Describe the changes from the previous map. We can see county names as we hover over. 
...
**Answer** Put the URL of your map here. https://datawrapper.dwcdn.net/93UJQ/1/
