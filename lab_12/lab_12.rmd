...
2022-04-19, SUSPICIOUS EVENT, 7 times in the last 30 days. 
...
maryland_vax_cleaned <-maryland_zips_data%>%
  ...
  maryland_vax_cleaned%>%mutate(ZIP_CODE = str_sub(ZIP_CODE, start=1L, end=5L))
  
  
  
  %>%
    filter(ZIP_CODE 20588, < 21930)
...
totalvax_by_zip <- read.csv("https://raw.githubusercontent.com/state-of-maryland/VaccineCSVs/master/Vax_ZIP_CODE_FirstSecondSingle_Totals_Raw.csv")
```
