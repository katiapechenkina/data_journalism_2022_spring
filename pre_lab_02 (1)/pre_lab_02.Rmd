...
```
Description:The code puts all Maryland ppp loans that were used to pay for payroll data in descending order. 
...
```
Description:The code filters data by MD based lenders servicing the ppp loans. 
...
head(prince_georges)
```
Description: The code filtered Maryland loan data by PG County data only. 
...
**Answer**date_approved is <chr> or "character" type 
...
**Answer** date_approved is <chr> or "character" type
CleanDate` is NA, maybe because there is an issue that came up. 
...
**Answer** Description: the code grouped loans approved by month and sorted in descending order. 
April of 2020 saw the most, total of 45042 applications approved. 
